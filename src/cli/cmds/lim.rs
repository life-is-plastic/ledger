...
impl Lim {
    pub fn run(
        ...
        Ok(cli::Output::Limitprinter(printer_config))
    }
}
    ...
    cli::testing::generate_testcases![
        (
            ...
            cli::testing::Case {
                invocations: &[cli::testing::Invocation {
                    args: &["", "lim", "2015", "--set", "0"],
                    res: cli::testing::ResultMatcher::OkStrGlob("2015 has no limit."),
                }],
        ...
        (
            ...
            cli::testing::MutCase {
                invocations: &[cli::testing::Invocation {
                    args: &["", "lim", "2015", "--set", "0"],
                    res: cli::testing::ResultMatcher::OkStrGlob("2015 limit removed."),
                }],
        ...
        (
            ...
            cli::testing::MutCase {
                invocations: &[cli::testing::Invocation {
                    ...
                    res: cli::testing::ResultMatcher::OkStrGlob("2016 limit set to (1.23)"),
                }],
                initial_state: cli::testing::StrState::new()
                    .with_config("{}")
                    .with_limits(r#"{"2015":1}"#),
        ...
        (
            ...
            cli::testing::Case {
                invocations: &[cli::testing::Invocation {
                    ...
                    res: cli::testing::ResultMatcher::OkExact(cli::Output::Limitprinter(
                ...
                initial_state: cli::testing::StrState::default()
                    .with_config("{}")
                    .with_limits(
                        r#"{
                            "2014": 100,
        ...
        (
            ...
            cli::testing::Case {
                invocations: &[cli::testing::Invocation {
                    args: &["", "lim"],
                    res: cli::testing::ResultMatcher::ErrGlob("no default account type configured"),
                }],
                initial_state: cli::testing::StrState::new().with_config("{}"),
            }
        ),
