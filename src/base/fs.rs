...
mod tests {
    ...
    fn path() {
        ...
        let b = fs.path::<base::Recordlist>();
        let c = fs.path::<base::Limits>();
        assert_ne!(a, b);
        assert_ne!(b, c);
        assert_ne!(a, c);
    }
